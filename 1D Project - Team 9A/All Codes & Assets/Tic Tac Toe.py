...
screen.title("Welcome to Tic Tac Toe")
...
def play(x,y):
    ...
    r = gameover(b)
    if r==1:
        screen.textinput("Game over!","OH NO THE COMPUTER WON NOOOO:((!")
    elif r==2:
        screen.textinput("Game over!","YAYYY I WONN, IN YOUR FACE COMPUTERRR!")
    elif r==3:
